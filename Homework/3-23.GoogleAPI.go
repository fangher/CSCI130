...
const rootForm = `
  <!DOCTYPE html>
    <html>
      ...
      <body>
      <h1>Show Restaurants</h1>
        <form style="margin-left: 120px;" action="/places" method="post" accept-charset="utf-8">
...
func places(w http.ResponseWriter, r *http.Request) {
  	...
  	fullUrl := fmt.Sprintf(
  		"https://maps.googleapis.com/maps/api/place/textsearch/xml?query=restaurants+in+%s&key=AIzaSyD0nwU7DxevIexVJqoLCGy2rX2lred9568", addr1)
